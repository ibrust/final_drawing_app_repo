...
struct Pixel {
    ...
    func blend(_ other: Pixel) -> Pixel {
        ...
        let invariant = a2 * (1 - a1)
        
        return Pixel(
            UInt8((a1 * CGFloat(self.r)) + (invariant * CGFloat(other.r))),
            UInt8((a1 * CGFloat(self.g)) + (invariant * CGFloat(other.g))),
            UInt8((a1 * CGFloat(self.b)) + (invariant * CGFloat(other.b))),
            UInt8((255 * (a1 + invariant)))
        )
    }
